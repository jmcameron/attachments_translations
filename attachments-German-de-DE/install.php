...
class attachments_de_de_language_packInstallerScript 
{
	...
	public function preflight($type, $parent)
	{
		...
		if ( version_compare(JVERSION, $this->minimum_joomla_release, 'lt') ) {
			$msg = JText::sprintf('ATTACHMENTS_DE_DE_LANGUAGE_PACK_ERROR_INADEQUATE_JOOMLA_VERSION_S',
		...
		{
			$msg = JText::_('ATTACHMENTS_DE_DE_LANGUAGE_PACK_ERROR_INSTALL_COMPONENT_FIRST');
			$app->enqueueMessage($msg, 'error');
			return false;
		}
	}
